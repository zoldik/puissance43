...
public class Header extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        out.println("<div class=\"menu\"><!-- début de la boite contenant les onglets -->"+
                ...
                "<a class=\"onglet\" href=\"#\" onmouseover=\"fonctionContenu('NetworkDevices'); fonctionClean('NetworkDevices'); fonctionMenu('NetworkDevices'); return false;\"><div id=\"NetworkDevices\">NetworkDevices</div></a>"+
                "<a class=\"onglet\" href=\"#\" onmouseover=\"fonctionContenu('NetworkSolutions'); fonctionClean('NetworkSolutions'); fonctionMenu('NetworkSolutions'); return false;\"><div id=\"NetworkSolutions\">NetworkSolutions</div></a>"+
