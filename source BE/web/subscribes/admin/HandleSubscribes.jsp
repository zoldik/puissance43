...
<html>
    ...
    <body>        
        ...
        <center>Abonnement internet</center><hr> 
...
%>        
        ...
        <center>Abonnement voip</center><hr> 
...
%>        
        ...
        <center>Abonnement vod</center><hr>     
            ...
            while (itVal.hasNext()) {
                ...
                <tr><td><%=customerTO.getId()%></td>
                    ...
                    <td><form method='post' action="CtrSubscribe">
                            ...
                            <input type='hidden' name='idCustomerInternet' value='<%=customerTO.getId()%>'>                        
                    </form></td>
            ...
            while (itValVoip.hasNext()) {
                ...
                <tr><td><%=customerTO.getId()%></td>
                    ...
                    <td><form method='post' action="CtrSubscribe">
                            ...
                            <input type='hidden' name='idCustomerVoip' value='<%=customerTO.getId()%>'>                        
                    </form></td>
            ...
            while (itValVod.hasNext()) {
                ...
                <tr><td><%=customerTO.getId()%></td>
                    ...
                    <td><form method='post' action="CtrSubscribe">
                            ...
                            <input type='hidden' name='idCustomerVod' value='<%=customerTO.getId()%>'>                        
                    </form></td>
